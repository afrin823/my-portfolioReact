            ...
            <section className=" bg-slate-900  bg-[url('https://i.ibb.co/RCLYHn5/bg.png')]" >
                <div className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
                    <div className="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
                        ...
                        <p className="mt-6 mb-8 text-lg sm:mb-12 text-[#939393]">Dictum aliquam porta in condimentum ac integer
                    ...
                    <div className="flex items-center justify-center p-6 mt-8 lg:mt-0 h-72 sm:h-80 lg:h-96 xl:h-112 2xl:h-128 ">
                        <div className='animate-border i nline-block rounded-full bg-white bg-gradient-to-r from-yellow-500 via-red-500 to-green-500 bg-[length:400%_400%] p-1'>
                            <img src="https://i.ibb.co/SfhQMZf/Whats-App-Image-2024-01-20-at-11-53-56-cc586bd7-removebg-preview.png" alt="" className="rounded-full object-contain h-72 sm:h-80 lg:h-96 xl:h-112 2xl:h-128 animate-border i nline-block bg-white bg-gradient-to-r from-red-500 via-purple-500 to-blue-500 bg-[length:400%_400%] p-1" />
                        </div>
